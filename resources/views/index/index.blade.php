...
<div class="head-top">
      ...
      <dt>
       ...
       <dd>
        ...
        <ul>
         <li><a href="prolist.html"><strong>{{$isbest}}</strong><p>全部商品</p></a></li>
     ...
     @if(request()->session()->get('user'))
          <h3 color="red">欢迎 15095064517 登录</h3>
     @endif
    
     <div id="sliderA" class="slider">
      @if($ishuan)
      @foreach($ishuan as $v)
         <a href="{{url('/pronav/'.$v->goods_id)}}"><img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}" /></a>
     @endforeach
     @endif
     </div><!--sliderA/-->
     <ul class="pronav">
