...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private static $map = [
        ...
        'audio/tta' => ['tta'],
        'audio/usac' => ['loas', 'xhe'],
        'audio/vnd.audible' => ['users', 'aax'],
        'audio/vnd.audible.aax' => ['users', 'aax'],
        ...
        'audio/x-pn-audibleaudio' => ['users', 'aax'],
    ...
    private static $reverseMap = [
        ...
        'users' => ['audio/vnd.audible', 'audio/vnd.audible.aax', 'audio/x-pn-audibleaudio'],
